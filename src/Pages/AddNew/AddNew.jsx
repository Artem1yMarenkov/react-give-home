...
export default function AddNew() {
    return (
        ...
        <div className="wrapper">
            ...
            {/* <input type="file" className='wrapper__photo' placeholder='Загрузить фото из UI либы'></input> */}
            ...
            <div className='wrapper__description'>
              ...
              <input className='wrapper__div4' placeholder='Введите что-то там'></input>
              <div >
                <button className='wrapper__button-save ' sx={{ color: 'white', }} color="secondary" variant="contained">Сохранить</button>
              </div>
            </div>
